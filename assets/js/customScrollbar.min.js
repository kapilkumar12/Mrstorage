!(function (e) {
  ...
  function t(t) {
    var l = t || window.event,
      ...
      p = 0;
    if (
      (((t = e.event.fix(l)).type = "mousewheel"),
      "detail" in l && (h = -1 * l.detail),
      "wheelDelta" in l && (h = l.wheelDelta),
      "wheelDeltaY" in l && (h = l.wheelDeltaY),
      "wheelDeltaX" in l && (u = -1 * l.wheelDeltaX),
      "axis" in l && l.axis === l.HORIZONTAL_AXIS && ((u = -1 * h), (h = 0)),
      (c = 0 === h ? u : h),
      "deltaY" in l && (c = h = -1 * l.deltaY),
      "deltaX" in l && ((u = l.deltaX), 0 === h && (c = -1 * u)),
      0 !== h || 0 !== u)
    ) {
      if (1 === l.deltaMode) {
      ...
      if (
        ...
        (!i || i > f) && ((i = f), n(l, f) && (i /= 40)),
        n(l, f) && ((c /= 40), (u /= 40), (h /= 40)),
  ...
  if (e.event.fixHooks)
    for (var c = l.length; c; ) e.event.fixHooks[l[--c]] = e.event.mouseHooks;
        ...
        var t,
              ...
              return e(a).each(function () {
                ...
                if (t.data(n)) {
                  ...
                  a.tweenRunning && V(t),
                    ...
                    b.call(this),
                    T.call(this);
                  var c = [Math.abs(l[0].offsetTop), Math.abs(l[0].offsetLeft)];
                  "x" !== i.axis &&
                    (a.overflowed[0]
            ...
            destroy: function () {
              ...
              return e(t).each(function () {
                ...
                if (a.data(n)) {
                  ...
                  l.live && m(l.liveSelector || e(t).selector),
                    N.call(this, "remove"),
                    M.call(this),
                    B.call(this),
                    a.removeData(n),
          ...
          v = function () {
            var t = e(this),
              a = t.data(n),
              i = a.opt,
              l = i.autoExpandScrollbar ? " " + d[1] + "_expand" : "",
              r = [
                "<div id='mCSB_" +
                  a.idx +
              ...
              s =
                "yx" === i.axis
                  ...
                  ? "mCSB_horizontal"
                  : "mCSB_vertical",
              c = "yx" === i.axis ? r[0] + r[1] : "x" === i.axis ? r[1] : r[0],
              u =
                "yx" === i.axis
                  ? "<div id='mCSB_" +
                    a.idx +
          ...
          w = function () {
            ...
            if (a.advanced.autoExpandHorizontalScroll && "y" !== a.axis) {
              ...
              var l = Math.ceil(i[0].scrollWidth);
              3 === a.advanced.autoExpandHorizontalScroll ||
              (2 !== a.advanced.autoExpandHorizontalScroll &&
                l > i.parent().width())
                ? i.css({
                    width: l,
                    "min-width": "100%",
          ...
          S = function () {
            var t = e(this),
              ...
              r = [
                a.height() / i.outerHeight(!1),
                a.width() / i.outerWidth(!1),
              ],
              c = [
                parseInt(l[0].css("min-height")),
                Math.round(r[0] * l[0].parent().height()),
                parseInt(l[1].css("min-width")),
                Math.round(r[1] * l[1].parent().width()),
              ],
              d = s && c[1] < c[0] ? c[0] : c[1],
              u = s && c[3] < c[2] ? c[2] : c[3];
            l[0]
              .css({ height: d, "max-height": l[0].parent().height() - 10 })
              .find(".mCSB_dragger_bar")
              .css({ "line-height": c[0] + "px" }),
              l[1].css({ width: u, "max-width": l[1].parent().width() - 10 });
          },
          b = function () {
            var t = e(this),
              o = t.data(n),
              ...
              r = [
                i.outerHeight(!1) - a.height(),
                i.outerWidth(!1) - a.width(),
              ],
              s = [
                r[0] / (l[0].parent().height() - l[0].height()),
                r[1] / (l[1].parent().width() - l[1].width()),
              ];
          ...
          y = function () {
            var t = e(this),
              ...
              a = e("#mCSB_" + o.idx),
              i = e("#mCSB_" + o.idx + "_container"),
              l = null == o.overflowed ? i.height() : i.outerHeight(!1),
              r = null == o.overflowed ? i.width() : i.outerWidth(!1),
              s = i[0].scrollHeight,
              c = i[0].scrollWidth;
            return (
              s > l && (l = s),
              c > r && (r = c),
              [l > a.height(), r > a.width()]
            );
          },
          B = function () {
            var t = e(this),
            ...
            if (
              ...
              (("x" !== a.axis && !o.overflowed[0]) ||
                ...
                (r[0].add(l).css("top", 0), Q(t, "_resetY")),
              ("y" !== a.axis && !o.overflowed[1]) ||
                ("x" === a.axis && o.overflowed[1]))
            ) {
              var s = (dx = 0);
              "rtl" === o.langDir &&
                ((s = i.width() - l.outerWidth(!1)),
          ...
          T = function () {
            ...
            a.bindEvents ||
              (O.call(this),
              i.contentTouchScroll && I.call(this),
              E.call(this),
              i.mouseWheel.enable &&
                (function n() {
              ...
              i.scrollButtons.enable && Y.call(this),
              i.keyboard.enable && j.call(this),
              (a.bindEvents = !0));
          },
          M = function () {
            var t = e(this),
            ...
            a.advanced.releaseDraggableSelectors &&
              r.add(e(a.advanced.releaseDraggableSelectors)),
              a.advanced.extraDraggableSelectors &&
          ...
          k = function (t) {
            var o = e(this),
              a = o.data(n),
              i = a.opt,
              l = e("#mCSB_" + a.idx + "_container_wrapper"),
              r = l.length ? l : e("#mCSB_" + a.idx + "_container"),
              s = [
              ...
              (a.overflowed[0] && !t
                ...
                : (i.alwaysShowScrollbar
                    ? (2 !== i.alwaysShowScrollbar &&
                      ...
                      r.removeClass(d[10]))
                    : (s[0].css("display", "none"), r.addClass(d[10])),
                  r.addClass(d[8]))),
              "y" !== i.axis &&
                (a.overflowed[1] && !t
                  ? (s[1]
                  ...
                  : (i.alwaysShowScrollbar
                      ? (2 !== i.alwaysShowScrollbar &&
                        ...
                        r.removeClass(d[11]))
                      : (s[1].css("display", "none"), r.addClass(d[11])),
                    r.addClass(d[9]))),
          ...
          D = function (t) {
            ...
            switch (o) {
              ...
              case "MSPointerUp":
                return n
                  ? [
                      t.originalEvent.pageY - n[0] + a[0],
                      t.originalEvent.pageX - n[1] + a[1],
                      !1,
                    ]
              ...
              case "touchend":
                ...
                return t.target.ownerDocument !== document
                  ? [i.screenY, i.screenX, l > 1]
                  : [i.pageY, i.pageX, l > 1];
              default:
                return n
                  ? [t.pageY - n[0] + a[0], t.pageX - n[1] + a[1], !1]
                  : [t.pageY, t.pageX, !1];
            }
          },
          O = function () {
            function t(e, t, n, a) {
              if (
                ((f[0].idleTimer = d.scrollInertia < 233 ? 250 : 0),
                o.attr("id") === h[1])
              )
                var i = "x",
                  s = (o[0].offsetLeft - t + a) * r.scrollRatio.x;
              else
                var i = "y",
                  s = (o[0].offsetTop - e + n) * r.scrollRatio.y;
              Q(l, s.toString(), { dir: i, drag: !0 });
            }
            var o,
              a,
              i,
            ...
            m
              ...
              .bind(
                ...
                function (t) {
                  if (
                    (t.stopImmediatePropagation(), t.preventDefault(), $(t))
                  ) {
                    (c = !0),
                      s &&
          ...
          I = function () {
            ...
            function a(e) {
              if (
                ...
                if (
                  (E.push(o),
                  L.push(n),
                  (z[2] = Math.abs(D(e)[0] - z[0])),
                  (z[3] = Math.abs(D(e)[1] - z[1])),
                  B.overflowed[0])
                )
                  var i = I[0].parent().height() - I[0].height(),
                    l =
                      u - o > 0 &&
                      o - u > -i * B.scrollRatio.y &&
                      (2 * z[3] < z[2] || "yx" === T.axis);
                if (B.overflowed[1])
                  var r = I[1].parent().width() - I[1].width(),
                    f =
                      h - n > 0 &&
                      n - h > -r * B.scrollRatio.x &&
                      (2 * z[2] < z[3] || "yx" === T.axis);
                l || f
                  ? (X || e.preventDefault(), (b = 1))
                  ...
                  (_ =
                    "yx" === T.axis
                      ...
                      : [u - o, null]),
                  (O[0].idleTimer = 250),
                  B.overflowed[0] && s(_[0], R, a, "y", "all", !0),
                  B.overflowed[1] && s(_[1], R, a, "x", W, !0);
              }
            }
            function i(e) {
              if (!ee(e) || c || D(e)[2]) t = 0;
              else {
                (t = 1), e.stopImmediatePropagation(), V(y), (p = G());
                var o = k.offset();
                (f = D(e)[0] - o.top),
                  (m = D(e)[1] - o.left),
                  (E = []),
            ...
            function l(e) {
              if (ee(e) && !c && !D(e)[2]) {
                ...
                if (!(v - g > 30)) {
                  var a = "mcsEaseOut",
                    i = 2.5 > (w = 1e3 / (v - p)),
                    l = i ? [E[E.length - 2], L[L.length - 2]] : [0, 0];
                  x = i ? [o - l[0], n - l[1]] : [o - f, n - m];
                  var u = [Math.abs(x[0]), Math.abs(x[1])];
                  w = i ? [Math.abs(x[0] / 4), Math.abs(x[1] / 4)] : [w, w];
                  var h = [
                    Math.abs(O[0].offsetTop) - x[0] * r(u[0] / w[0], w[0]),
                    Math.abs(O[0].offsetLeft) - x[1] * r(u[1] / w[1], w[1]),
                  ];
                  (_ =
                    "yx" === T.axis
                      ? [h[0], h[1]]
                  ...
                  (_[0] = u[0] > y ? _[0] : 0),
                    (_[1] = u[1] > y ? _[1] : 0),
                    B.overflowed[0] && s(_[0], S[0], a, "y", W, !1),
                    B.overflowed[1] && s(_[1], S[1], a, "x", W, !1);
                }
              }
            }
            function r(e, t) {
            ...
            var d,
              ...
              H = O.find("iframe"),
              P = [
                "touchstart." + M + " pointerdown." + M + " MSPointerDown." + M,
                "touchmove." + M + " pointermove." + M + " MSPointerMove." + M,
                "touchend." + M + " pointerup." + M + " MSPointerUp." + M,
              ],
              X =
          ...
          E = function () {
            function o(e, t, o) {
              (s.type = o && a ? "stepped" : "stepless"),
                (s.scrollAmount = 10),
                U(i, e, t, "mcsLinearOut", o ? 60 : null);
            }
            var a,
              i = e(this),
              l = i.data(n),
            ...
            u.bind("mousedown." + d, function () {
              ...
              .bind("mousemove." + d, function (e) {
                if (
                  ...
                  var n = u.offset(),
                    i = D(e)[0] - n.top + u[0].offsetTop,
                    c = D(e)[1] - n.left + u[0].offsetLeft;
              ...
              if ((V(o), !z(o, t.target))) {
                  ...
                  var u = "y",
                    ...
                    f =
                      "auto" !== i.mouseWheel.scrollAmount
                        ...
                        : h[0],
                    m = Math.abs(
                      e("#mCSB_" + a.idx + "_container")[0].offsetTop
                    ),
                    p = c[0][0].offsetTop,
                ...
                ("y" === u && !a.overflowed[0]) ||
                  ...
                  t.deltaFactor < 5 &&
                    ...
                    ((f = t.deltaFactor), (d = 17)),
                  Q(o, (m - v * f).toString(), { dir: u, dur: d }));
              }
            }
            if (e(this).data(n)) {
              var o = e(this),
                ...
                d.each(function () {
                  e(this).bind("load", function () {
                    A(this) &&
                      ...
                      ).bind("mousewheel." + l, function (e, o) {
                        t(e, o);
                      });
                  });
                }),
                r.bind("mousewheel." + l, function (e, o) {
                  t(e, o);
                });
            }
          },
          ...
          A = function (t) {
            ...
            if (
              (void 0 === t
                ? (n = "#empty")
                : void 0 !== e(t).attr("id") && (n = e(t).attr("id")),
              !1 !== n && void 0 !== R[n])
            )
              return R[n];
            if (t) {
          ...
          z = function (t, o) {
            ...
            return (
              e.inArray(a, i) > -1 &&
              !(e.inArray(a, ["select", "textarea"]) > -1 && !e(o).is(":focus"))
            );
          },
          H = function () {
            var t,
              ...
              l = e("#mCSB_" + a.idx + "_container"),
              r = l.parent(),
              s = e(".mCSB_" + a.idx + "_scrollbar ." + d[12]);
            s.bind(
              "mousedown." +
                i +
                " touchstart." +
                ...
                if (
                  ...
                  if (i.parent(".mCSB_scrollTools_horizontal").length > 0) {
                    ...
                    var c = "x",
                      ...
                      h = Math.abs(l[0].offsetLeft) - u * (0.9 * r.width());
                  } else {
                    if (!a.overflowed[0]) return;
                    var c = "y",
                      u = n.pageY > s.offset().top ? -1 : 1,
                      h = Math.abs(l[0].offsetTop) - u * (0.9 * r.height());
                  }
                  Q(o, h.toString(), { dir: c, scrollEasing: "mcsEaseInOut" });
                }
              });
          },
          P = function () {
            ...
            l.bind("focusin." + i, function () {
              ...
              o.is(a.advanced.autoScrollOnFocus) &&
                ...
                (t[0]._focusTimeout = setTimeout(function () {
                  var e = [oe(o)[0], oe(o)[1]],
                    n = [l[0].offsetTop, l[0].offsetLeft],
                    i = [
                      n[0] + e[0] >= 0 &&
                        n[0] + e[0] < r.height() - o.outerHeight(!1),
                      n[1] + e[1] >= 0 &&
                        n[0] + e[1] < r.width() - o.outerWidth(!1),
                    ],
          ...
          Y = function () {
            var t = e(this),
              ...
              s = e(r + ">a");
            s.bind("contextmenu." + l, function (e) {
              e.preventDefault();
            }).bind(
              "mousedown." +
                l +
          ...
          j = function () {
            function t(t) {
              function n(e, t) {
                (l.type = i.keyboard.scrollType),
                  (l.scrollAmount = i.keyboard.scrollAmount),
                  ("stepped" === l.type && a.tweenRunning) || U(o, e, t);
              }
              switch (t.type) {
                case "blur":
                  a.tweenRunning && l.dir && n("off", null);
                  break;
                case "keydown":
                case "keyup":
                  ...
                  if (
                    ...
                    if (
                      ...
                      if (
                        ...
                        var f = "x",
                          m = Math.abs(c[0].offsetLeft) - h * (0.9 * d.width());
                      else
                        var f = "y",
                          m = Math.abs(c[0].offsetTop) - h * (0.9 * d.height());
                      Q(o, m.toString(), {
                        dir: f,
                        scrollEasing: "mcsEaseInOut",
                      });
                    ...
                    if (
                      ...
                      var f = "x",
                        m =
                          35 === r ? Math.abs(d.width() - c.outerWidth(!1)) : 0;
                    else
                      var f = "y",
                        m =
                          35 === r
          ...
          U = function (t, o, a, i, l) {
            function r(e) {
              ...
              var o = "stepped" !== u.type,
                ...
                v =
                  "x" === u.dir[0]
                    ? d[1] + u.dir[1] * parseInt(u.scrollAmount)
          ...
          q = function (t, o) {
            if (null != t && void 0 !== t) {
              ...
              var d =
                  "x" === o
                    ? r.outerWidth(!1) - s.width()
                    : r.outerHeight(!1) - s.height(),
                h = "x" === o ? r[0].offsetLeft : r[0].offsetTop,
                f = "x" === o ? "left" : "top";
              switch (c) {
                case "function":
                  return t();
                ...
                case "number":
                  ...
                  return e(t).length
                    ? "x" === o
                      ? oe(e(t))[1]
                      : oe(e(t))[0]
                    : (r.css(f, t), void u.update.call(null, a[0]));
              }
            }
          },
          N = function (t) {
            function o(e) {
              clearTimeout(r[0].autoUpdate), u.update.call(null, a[0], e);
            }
            var a = e(this),
              i = a.data(n),
              l = i.opt,
              r = e("#mCSB_" + i.idx + "_container");
            return t
              ? (clearTimeout(r[0].autoUpdate), void K(r[0], "autoUpdate"))
              : void (function t() {
                  return (
                          ...
                          return l.advanced.updateOnSelectorChange &&
                            ...
                            : !l.advanced.updateOnImageLoad ||
                              ("auto" === l.advanced.updateOnImageLoad &&
                                "y" === l.axis) ||
                              ((i.poll.img.n = r.find("img").length),
          ...
          Q = function (t, o, a) {
            function i(e) {
              return r && s.callbacks[e] && "function" == typeof s.callbacks[e];
            }
            function l() {
            ...
            var r = t.data(n),
              ...
              m = s.callbacks.onTotalScrollOffset
                ? F.call(t, s.callbacks.onTotalScrollOffset)
                : [0, 0],
              ...
              switch (a.dir) {
                case "x":
                  var v = e("#mCSB_" + r.idx + "_dragger_horizontal"),
                    ...
                    S = [o, 0 === o ? 0 : o / r.scrollRatio.x],
                    b = m[1],
                    y = p[1],
                    B = b > 0 ? b / r.scrollRatio.x : 0,
                    T = y > 0 ? y / r.scrollRatio.x : 0;
                  break;
                case "y":
                  var v = e("#mCSB_" + r.idx + "_dragger_vertical"),
                    ...
                    S = [o, 0 === o ? 0 : o / r.scrollRatio.y],
                    b = m[0],
                    y = p[0],
                    B = b > 0 ? b / r.scrollRatio.y : 0,
                    T = y > 0 ? y / r.scrollRatio.y : 0;
              }
              S[1] < 0 || (0 === S[0] && 0 === S[1])
                ? (S = [0, 0])
                : S[1] >= _[1]
                ? (S = [_[0], _[1]])
                : (S[0] = -S[0]),
                t[0].mcs || (l(), i("onInit") && s.callbacks.onInit.call(t[0])),
                clearTimeout(h[0].onCompleteTimeout),
                Z(v[0], x, Math.round(S[1]), d[1], a.scrollEasing),
                (!r.tweenRunning &&
                  ((0 === w && S[0] >= 0) || (w === _[0] && S[0] <= _[0]))) ||
                  Z(
                    h[0],
                    x,
                    Math.round(S[0]),
                    ...
                    a.overwrite,
                    {
                      onStart: function () {
                        a.callbacks &&
                          ...
                          !r.tweenRunning &&
                          (i("onScrollStart") &&
                            (l(), s.callbacks.onScrollStart.call(t[0])),
                          (r.tweenRunning = !0),
                          C(v),
                          (r.cbOffsets = [
                            s.callbacks.alwaysTriggerOffsets || w >= _[0] + b,
                            s.callbacks.alwaysTriggerOffsets || -y >= w,
                          ]));
                      },
                      onUpdate: function () {
                        a.callbacks &&
                          a.onUpdate &&
                          i("whileScrolling") &&
                          (l(), s.callbacks.whileScrolling.call(t[0]));
                      },
                      onComplete: function () {
                        if (a.callbacks && a.onComplete) {
                          ...
                          h[0].onCompleteTimeout = setTimeout(function () {
                            i("onScroll") &&
                              (l(), s.callbacks.onScroll.call(t[0])),
                              i("onTotalScroll") &&
                                S[1] >= _[1] - B &&
                                r.cbOffsets[0] &&
                                (l(), s.callbacks.onTotalScroll.call(t[0])),
                              i("onTotalScrollBack") &&
                                S[1] <= T &&
                                r.cbOffsets[1] &&
                                (l(), s.callbacks.onTotalScrollBack.call(t[0])),
                              (r.tweenRunning = !1),
                              (h[0].idleTimer = 0),
                              C(v, "hide");
                          }, e);
              ...
              e.extend(e.expr[":"], {
                mcsInView:
                  ...
                  function (t) {
                    ...
                    if (i.length)
                      return (
                        (o = i.parent()),
                        (n = [i[0].offsetTop, i[0].offsetLeft])[0] + oe(a)[0] >=
                          0 &&
                ...
                mcsInSight:
                  ...
                  function (t, o, n) {
                    ...
                    if (c.length)
                      return (
                        (a = [s.outerHeight(!1), s.outerWidth(!1)]),
                        (l = [
                          c[0].offsetTop + oe(s)[0],
                          c[0].offsetLeft + oe(s)[1],
                        ]),
                        (i = [
